                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form name="form1" action="" method="post">
                                    <table class="table table-bordered">
                                        <tr>
                                                ...
                                                <?php
                                                $res=mysqli_query($_link,"select distinct student_enrollment from issue_books where books_return_date=''");
                                ...
                                <?php
                                    ...
                                    {
                                        $res=mysqli_query($_link,"select * from issue_books where student_enrollment='$_POST[enr]' && books_return_date=''");
                                        ...
                                        while($row=mysqli_fetch_array($res))
                                        {
                                            ...
                                            echo"<td>"; ?> <a href="return.php? id=<?php echo $row["id"]; ?>" style="color:red"> return books</a> <?php echo"</td>";
                                            echo "</tr>";
                                        }
                                        echo"</table>";
                         }
